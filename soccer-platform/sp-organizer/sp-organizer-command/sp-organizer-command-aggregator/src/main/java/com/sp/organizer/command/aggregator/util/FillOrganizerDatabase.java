package com.sp.organizer.command.aggregator.util;
...
public class FillOrganizerDatabase {
	...
	@Autowired
	public FillOrganizerDatabase(CompetitionService competitionService, ClubService clubService, MatchService matchService) {
