var app = angular.module('app', [ 'ngRoute', 'playerModule', 'competitionModule', 'navigationModule', 'matchModule', 'clubModule', 'spring-data-rest', 'smart-table' ]);
...
app.config([ '$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
	...
	$routeProvider.when('/players', {
		...
		templateUrl : 'static/public/partials/com.sp.organizer.backend.club/com.sp.organizer.backend.club.html',
		controller : 'clubCtrl',
		activetab: 'club'
