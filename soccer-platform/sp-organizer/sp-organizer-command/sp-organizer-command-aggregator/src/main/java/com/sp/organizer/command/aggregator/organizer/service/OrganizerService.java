...
public class OrganizerService {
    ...
    public CompletableFuture<EntityWithIdAndVersion<OrganizerAggregate>> addCompetition(AddCompetitionOrganizerCommand addStageCommand, String competitionId) {
        return organizerAggregateRepository.update(competitionId, addStageCommand);
    }
